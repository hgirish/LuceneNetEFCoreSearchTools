...
{
    public class SearchableContextProvider<TContext> : ISearchableContextProvider<TContext> where TContext: class, new()
    {
        public TContext Context { get; protected set; }
        private DbContext contextInterface;
        ...
        public void Initialize(LuceneIndexerOptions indexerOptions, bool overrideIfExists = false)
        {
            ...
            contextInterface = Context as DbContext;

            //Context = new CTX();
            //contextInterface = Context as IDbContext;
        }

        public void Initialize(LuceneIndexerOptions indexerOptions, TContext entity, bool overrideIfExists = false)
        {
            if (isInitialized == false || overrideIfExists == true)
            {
                initializeLucene(indexerOptions);
        ...
        private ILuceneIndexable GetConcreteFromDocument(Document doc)
        {
            ...
            var entity = contextInterface.Find(t, id);
